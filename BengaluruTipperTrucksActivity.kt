...
class BengaluruTipperTrucksActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_available_tipper_trucks_bengaluru)
        ...
        findViewById<Button>(R.id.bookNow1)?.setOnClickListener {
            val intent = Intent(this@BengaluruTipperTrucksActivity, BookingSummaryActivity::class.java)
            intent.putExtra("truckName", "TATA Tipper")
            intent.putExtra("truckPrice", "₹ 40 / Km")
            intent.putExtra("pricePerKm", 40.0)
            intent.putExtra("truckStyle", "Tata SIGNA 3523.TK")
        ...
        findViewById<Button>(R.id.bookNow2)?.setOnClickListener {
            val intent = Intent(this@BengaluruTipperTrucksActivity, BookingSummaryActivity::class.java)
            intent.putExtra("truckName", "BHARAT BENZ Tipper")
            intent.putExtra("truckPrice", "₹ 42 / Km")
            intent.putExtra("pricePerKm", 42.0)
            intent.putExtra("truckStyle", "BHARAT BENZ DE21OBS4")
            intent.putExtra("truckType", "Manual")
            intent.putExtra("truckColor", "Yellow")
